...
Steps: 
Make sure to install a Devanagari script keyboard layout and familiarizing how it works

Simply open the file Sanskrit_Teacher_Program.py with an IDE of your choice and run it and follow the steps it asks.